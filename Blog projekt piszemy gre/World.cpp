...
void World::set_beInside(int data1) { beInside = data1; } //mo¿na te¿ napisaæ: ...set_beInside(int beInside) { this -> beInside = beInside; } co dobrze sobie zapamiêtaæ, bo œwietnie obrazuje dzia³anie operatora this.
